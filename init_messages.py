...
class InitMessages(object):
    ...
    def __init__(self):
        ...
        self.blog_after_date = datetime.datetime.strptime("2017-04-30", "%Y-%m-%d")  # 爬这个时间之后的日志
        self.mood_after_date = datetime.datetime.strptime("2016-04-20", "%Y-%m-%d")  # 爬这个时间之后的说说
        ...
        self.fail_time = 5  # 打开网页失败几次不再打开
        self.timeout = 10  # 打开网页设置几秒为超时
